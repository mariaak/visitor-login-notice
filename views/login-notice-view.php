...
<div id="visitor-login-notice" class="vln-<?php echo $options['position']; ?>" style="<?php echo $vln_custom_styles;?>" >
	...
	<div class="vln-actions">
		...
		<a href="<?php echo esc_url( $options['register_url'] ); ?>" class="vln-btn vln-register-btn" style="background: <?php echo $options['secondary_btn_color']; ?>">
